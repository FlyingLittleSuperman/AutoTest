...
namespace GisqRealEstate.ProDataSource
{
	...
	public abstract class DbHelperOra
	{
        ...
        public static OracleConnection objConn = null;
		public DbHelperOra()
		{			
		...
		public static int ExecuteSql(string SQLString)
		{
            ...
            //else
            //{
            //    using (OracleCommand cmd = new OracleCommand(SQLString, objConn))
            //    {
            //        try
            //        {
            //            int rows = cmd.ExecuteNonQuery();
		...
		{		
			using (OracleConnection connection = new OracleConnection(connectionString))
			{
                ...
                OracleParameter myParameter = new System.Data.OracleClient.OracleParameter(":fs", OracleType.LongRaw);
		...
		public static DataSet Query(string SQLString)
		{
            ...
            //    try
            //    {
            //        OracleDataAdapter command = new OracleDataAdapter(SQLString, objConn);
            //        command.Fill(ds, "ds");
            //    }
            //    catch (System.Data.OracleClient.OracleException ex)
            //    {
		...
		public static DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, string tableName )
		{
            ...
            {
                OracleDataAdapter sqlDA = new OracleDataAdapter();
                sqlDA.SelectCommand = BuildQueryCommand(objConn, storedProcName, parameters);
                sqlDA.Fill(dataSet, tableName);
            }
            return dataSet;
		}
