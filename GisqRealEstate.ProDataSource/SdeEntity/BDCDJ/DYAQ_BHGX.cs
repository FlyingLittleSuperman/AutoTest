...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsDYAQBHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsDYAQBHGX obj)
		{
		...
		public void Colne(clsDYAQBHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsDYAQBHGXSet:EntityBaseSet
	{
		public clsDYAQBHGXSet()
		{
			m_TableName="BDCDJ.DYAQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsDYAQBHGXSet";
		}
		public static clsDYAQBHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsDYAQBHGXSet clsSet = new clsDYAQBHGXSet(); //(clsDYAQBHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsDYAQBHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsDYAQBHGX obj = (clsDYAQBHGX)entity;
			try
			{
