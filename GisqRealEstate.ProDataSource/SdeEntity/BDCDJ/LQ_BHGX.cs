...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsLQBHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsLQBHGX obj)
		{
		...
		public void Colne(clsLQBHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsLQBHGXSet:EntityBaseSet
	{
		public clsLQBHGXSet()
		{
			m_TableName="BDCDJ.LQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsLQBHGXSet";
		}
		public static clsLQBHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsLQBHGXSet clsSet = new clsLQBHGXSet(); //(clsLQBHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsLQBHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsLQBHGX obj = (clsLQBHGX)entity;
			try
			{
