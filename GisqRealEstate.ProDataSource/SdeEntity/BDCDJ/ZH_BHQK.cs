...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZHBHQK:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZHBHQK obj)
		{
		...
		public void Colne(clsZHBHQK obj)
		{
			this.BSM=obj.BSM;
	...
	public class clsZHBHQKSet:EntityBaseSet
	{
		public clsZHBHQKSet()
		{
			m_TableName="BDCDJ.ZH_BHQK";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZHBHQKSet";
		}
		public static clsZHBHQKSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZHBHQKSet clsSet = new clsZHBHQKSet(); //(clsZHBHQKSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZHBHQKSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZHBHQK obj = (clsZHBHQK)entity;
			try
			{
