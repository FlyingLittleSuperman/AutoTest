...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZDLQ_BHQK:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZDLQ_BHQK obj)
		{
		...
		public void Colne(clsZDLQ_BHQK obj)
		{
			this.BSM=obj.BSM;
	...
	public class clsZDLQ_BHQKSet:EntityBaseSet
	{
		public clsZDLQ_BHQKSet()
		{
			m_TableName="BDCDJ.ZD_LQ_BHQK";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZDLQ_BHQKSet";
		}
		public static clsZDLQ_BHQKSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZDLQ_BHQKSet clsSet = new clsZDLQ_BHQKSet(); //(clsZDLQ_BHQKSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZDLQ_BHQKSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZDLQ_BHQK obj = (clsZDLQ_BHQK)entity;
			try
			{
