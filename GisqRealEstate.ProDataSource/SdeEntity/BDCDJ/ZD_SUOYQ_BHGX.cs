...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZDSUOYQ_BHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZDSUOYQ_BHGX obj)
		{
		...
		public void Colne(clsZDSUOYQ_BHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsZDSUOYQ_BHGXSet:EntityBaseSet
	{
		public clsZDSUOYQ_BHGXSet()
		{
			m_TableName="BDCDJ.ZD_SUOYQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZDSUOYQ_BHGXSet";
		}
		public static clsZDSUOYQ_BHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZDSUOYQ_BHGXSet clsSet = new clsZDSUOYQ_BHGXSet(); //(clsZDSUOYQ_BHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZDSUOYQ_BHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZDSUOYQ_BHGX obj = (clsZDSUOYQ_BHGX)entity;
			try
			{
