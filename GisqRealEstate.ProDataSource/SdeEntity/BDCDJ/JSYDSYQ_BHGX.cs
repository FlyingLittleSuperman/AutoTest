...
namespace GisqRealEstate.ProDataSource
{
	...
	public class Fld_JSYDSYQBHGX
	{
		...
		public const string BZ_LZDQLR_ID="BZ_LZDQLR_ID";
		public const string BZ_XZDQLR_ID="BZ_XZDQLR_ID";
		public const string YXTBM="YXTBM";
		public const string YXTBSM="YXTBSM";
		public const string GXSJ="GXSJ";
		public const string BZ="BZ";
		public const string BZ_OLD_RIGHT_ID="BZ_OLD_RIGHT_ID";
		public const string BZ_RIGHT_ID="BZ_RIGHT_ID";
		#endregion
	}

	public class clsJSYDSYQBHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsJSYDSYQBHGX obj)
		{
		...
		public void Colne(clsJSYDSYQBHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsJSYDSYQBHGXSet:EntityBaseSet
	{
		public clsJSYDSYQBHGXSet()
		{
			m_TableName="BDCDJ.JSYDSYQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsJSYDSYQBHGXSet";
		}
		public static clsJSYDSYQBHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsJSYDSYQBHGXSet clsSet = new clsJSYDSYQBHGXSet(); //(clsJSYDSYQBHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsJSYDSYQBHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsJSYDSYQBHGX obj = (clsJSYDSYQBHGX)entity;
			try
			{
