...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZDSUOYQ:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZDSUOYQ obj)
		{
		...
		public void Colne(clsZDSUOYQ obj)
		{
			this.BSM=obj.BSM;
			this.ZDDM=obj.ZDDM;
	...
	public class clsZDSUOYQSet:EntityBaseSet
	{
		public clsZDSUOYQSet()
		{
			m_TableName="BDCDJ.ZD_SUOYQ";
			m_HisTableName="BDCDJ.ZD_SUOYQ_LS";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZDSUOYQSet";
		}
		public static clsZDSUOYQSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZDSUOYQSet clsSet = new clsZDSUOYQSet(); //(clsZDSUOYQSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZDSUOYQSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZDSUOYQ obj = (clsZDSUOYQ)entity;
			try
			{
