...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZHBHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZHBHGX obj)
		{
		...
		public void Colne(clsZHBHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsZHBHGXSet:EntityBaseSet
	{
		public clsZHBHGXSet()
		{
			m_TableName="BDCDJ.ZH_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZHBHGXSet";
		}
		public static clsZHBHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZHBHGXSet clsSet = new clsZHBHGXSet(); //(clsZHBHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZHBHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZHBHGX obj = (clsZHBHGX)entity;
			try
			{
