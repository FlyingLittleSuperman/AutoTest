...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZDNYDSYQ:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZDNYDSYQ obj)
		{
		...
		public void Colne(clsZDNYDSYQ obj)
		{
			this.BSM=obj.BSM;
			this.ZDDM=obj.ZDDM;
	...
	public class clsZDNYDSYQSet:EntityBaseSet
	{
		public clsZDNYDSYQSet()
		{
			m_TableName="BDCDJ.ZD_NYDSYQ";
			m_HisTableName="BDCDJ.ZD_NYDSYQ_LS";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZDNYDSYQSet";
		}
		public static clsZDNYDSYQSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZDNYDSYQSet clsSet = new clsZDNYDSYQSet(); //(clsZDNYDSYQSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZDNYDSYQSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZDNYDSYQ obj = (clsZDNYDSYQ)entity;
			try
			{
