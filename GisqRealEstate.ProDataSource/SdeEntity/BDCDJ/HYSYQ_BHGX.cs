...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsHYSYQBHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsHYSYQBHGX obj)
		{
		...
		public void Colne(clsHYSYQBHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsHYSYQBHGXSet:EntityBaseSet
	{
		public clsHYSYQBHGXSet()
		{
			m_TableName="BDCDJ.HYSYQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsHYSYQBHGXSet";
		}
		public static clsHYSYQBHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsHYSYQBHGXSet clsSet = new clsHYSYQBHGXSet(); //(clsHYSYQBHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsHYSYQBHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsHYSYQBHGX obj = (clsHYSYQBHGX)entity;
			try
			{
