...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsNYDSYQDYGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsNYDSYQDYGX obj)
		{
		...
		public void Colne(clsNYDSYQDYGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsNYDSYQDYGXSet:EntityBaseSet
	{
		public clsNYDSYQDYGXSet()
		{
			m_TableName="BDCDJ.NYDSYQ_DYGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsNYDSYQDYGXSet";
		}
		public static clsNYDSYQDYGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsNYDSYQDYGXSet clsSet = new clsNYDSYQDYGXSet(); //(clsNYDSYQDYGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsNYDSYQDYGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsNYDSYQDYGX obj = (clsNYDSYQDYGX)entity;
			try
			{
