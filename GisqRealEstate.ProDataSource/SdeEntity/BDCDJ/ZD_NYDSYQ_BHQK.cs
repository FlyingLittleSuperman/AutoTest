...
namespace GisqRealEstate.ProDataSource
{
	...
	public class Fld_ZDNYDSYQ_BHQK
	{
		#region 表列
	...
	public class clsZDNYDSYQ_BHQK:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZDNYDSYQ_BHQK obj)
		{
		...
		public void Colne(clsZDNYDSYQ_BHQK obj)
		{
			this.BSM=obj.BSM;
	...
	public class clsZDNYDSYQ_BHQKSet:EntityBaseSet
	{
		public clsZDNYDSYQ_BHQKSet()
		{
			m_TableName="BDCDJ.ZD_NYDSYQ_BHQK";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZDNYDSYQ_BHQKSet";
		}
		public static clsZDNYDSYQ_BHQKSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZDNYDSYQ_BHQKSet clsSet = new clsZDNYDSYQ_BHQKSet(); //(clsZDNYDSYQ_BHQKSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZDNYDSYQ_BHQKSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZDNYDSYQ_BHQK obj = (clsZDNYDSYQ_BHQK)entity;
			try
			{
