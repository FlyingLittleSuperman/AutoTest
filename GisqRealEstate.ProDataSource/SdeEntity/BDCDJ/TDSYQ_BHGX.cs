...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsTDSYQBHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsTDSYQBHGX obj)
		{
		...
		public void Colne(clsTDSYQBHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsTDSYQBHGXSet:EntityBaseSet
	{
		public clsTDSYQBHGXSet()
		{
			m_TableName="BDCDJ.TDSYQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsTDSYQBHGXSet";
		}
		public static clsTDSYQBHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsTDSYQBHGXSet clsSet = new clsTDSYQBHGXSet(); //(clsTDSYQBHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsTDSYQBHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsTDSYQBHGX obj = (clsTDSYQBHGX)entity;
			try
			{
