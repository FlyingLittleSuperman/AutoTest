...
namespace GisqRealEstate.ProDataSource
{
	...
	public class Fld_JSYDSYQDYGX
	{
		...
		public const string DB_ZDID="DB_ZDID";
		public const string DB_ZDQLR_ID="DB_ZDQLR_ID";
		...
		public const string BZ_BDCDYH="BZ_BDCDYH";
		#endregion
	}

	public class clsJSYDSYQDYGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsJSYDSYQDYGX obj)
		{
		...
		public void Colne(clsJSYDSYQDYGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsJSYDSYQDYGXSet:EntityBaseSet
	{
		public clsJSYDSYQDYGXSet()
		{
			m_TableName="BDCDJ.JSYDSYQ_DYGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsJSYDSYQDYGXSet";
		}
		public static clsJSYDSYQDYGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsJSYDSYQDYGXSet clsSet = new clsJSYDSYQDYGXSet(); //(clsJSYDSYQDYGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsJSYDSYQDYGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsJSYDSYQDYGX obj = (clsJSYDSYQDYGX)entity;
			try
			{
