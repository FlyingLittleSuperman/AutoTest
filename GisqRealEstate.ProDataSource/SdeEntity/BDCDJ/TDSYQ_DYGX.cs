...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsTDSYQDYGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsTDSYQDYGX obj)
		{
		...
		public void Colne(clsTDSYQDYGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsTDSYQDYGXSet:EntityBaseSet
	{
		public clsTDSYQDYGXSet()
		{
			m_TableName="BDCDJ.TDSYQ_DYGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsTDSYQDYGXSet";
		}
		public static clsTDSYQDYGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsTDSYQDYGXSet clsSet = new clsTDSYQDYGXSet(); //(clsTDSYQDYGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsTDSYQDYGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsTDSYQDYGX obj = (clsTDSYQDYGX)entity;
			try
			{
