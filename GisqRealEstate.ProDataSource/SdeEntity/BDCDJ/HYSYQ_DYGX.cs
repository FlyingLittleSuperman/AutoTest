...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsHYSYQDYGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsHYSYQDYGX obj)
		{
		...
		public void Colne(clsHYSYQDYGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsHYSYQDYGXSet:EntityBaseSet
	{
		public clsHYSYQDYGXSet()
		{
			m_TableName="BDCDJ.HYSYQ_DYGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsHYSYQDYGXSet";
		}
		public static clsHYSYQDYGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsHYSYQDYGXSet clsSet = new clsHYSYQDYGXSet(); //(clsHYSYQDYGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsHYSYQDYGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsHYSYQDYGX obj = (clsHYSYQDYGX)entity;
			try
			{
