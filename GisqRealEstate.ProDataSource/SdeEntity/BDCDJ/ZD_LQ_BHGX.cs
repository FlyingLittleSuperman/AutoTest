...
namespace GisqRealEstate.ProDataSource
{
	...
	public class clsZDLQ_BHGX:IEntity
	{
		...
		#endregion
		public bool IsEquals(clsZDLQ_BHGX obj)
		{
		...
		public void Colne(clsZDLQ_BHGX obj)
		{
			this.BSM=obj.BSM;
			this.YWH=obj.YWH;
	...
	public class clsZDLQ_BHGXSet:EntityBaseSet
	{
		public clsZDLQ_BHGXSet()
		{
			m_TableName="BDCDJ.ZD_LQ_BHGX";
			m_HisTableName="";
			m_PrimaryKeyName="BSM";
			m_SequenceName="BDCDJ.SEQ_BSM";
			m_ClsName="clsZDLQ_BHGXSet";
		}
		public static clsZDLQ_BHGXSet CreateObject(GisqLandProDataSource objDataSource)
		{
			clsZDLQ_BHGXSet clsSet = new clsZDLQ_BHGXSet(); //(clsZDLQ_BHGXSet)DataAccess.CreateObject("GisqLandSystem.DataEntity", "GisqLandSystem.DataEntity.clsZDLQ_BHGXSet");
		...
		protected override bool LetFieldsValue(DataRow datarow, IEntity entity)
		{
			...
			clsZDLQ_BHGX obj = (clsZDLQ_BHGX)entity;
			try
			{
