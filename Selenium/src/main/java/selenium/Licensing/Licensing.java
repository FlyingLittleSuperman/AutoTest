...
public class Licensing {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            driver.get("http://192.168.7.200:8084/GisqQueryList/views/reports/realestate/common/getcertisendcerti/SendCertiRECerti.jsp?" +
                    "reportlet=realestate/common/getcertisendcerti/SendCertiRECerti.cpt&op=write" +
                    "&BDFR_GUID=f186c617-e05d-11e5-8188-000c29187a9e&ID=81871ab2-c1c2-11e6-a3fa-9c5c8e949727&CATEGORY=BDC" +
                    "&RECORDNUMBER=375b04a3-25fc-40b7-b293-af422c0336f1&BIZDEF_GUID=f18677f1-e05d-11e5-8188-000c29187a9e" +
                    "&BIZINST_GUID=81754039-c1c2-11e6-a3fa-9c5c8e949727&TYPE=form" +
                    "&userId=f2e37658-69d2-11e5-a045-000c297c0f34&TRANSACTOR=zscs" +
                    "&aid=sid-70C1F275-F591-4E31-A8E7-E87BF8B26CA1&ACTDEFID=sid-70C1F275-F591-4E31-A8E7-E87BF8B26CA1" +
                    "&tid=04adfca3-c1c8-11e6-a192-9c5c8e949727" +
                    "&ACTINSTID=04adfca3-c1c8-11e6-a192-9c5c8e949727&pid=2d107839-0de3-11e6-b878-000c2984e60c" +
                    ...
                    "&PROJECTID=20161214-0039582&LCBM=2101&HJDM=FZ&XZQBM=3315&task_state=null");
            LicensingPerson.execute(driver);
    ...
    public static void execute(WebDriver driver) throws Exception {
        ...
        for (WebElement element : allElement) {
            try {
                ...
                //收费环节
                if (src1.indexOf("SendCertiRECerti.jsp") > -1) {
                    WebDriver driverRegisterCharge = driverFileBage.switchTo().frame(id);
                    LicensingPerson.execute(driverRegisterCharge);
                }
            } catch (Exception er) {
                er.printStackTrace();
            }
